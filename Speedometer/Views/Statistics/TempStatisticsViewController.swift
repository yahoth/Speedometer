//
//  TempStatisticsViewController.swift
//  Speedometer
//
...
class TempStatisticsViewController: UIViewController {
...
//                self.navigationController?.pushViewController(vc, animated: true)
    ...
    private func configureCollectionView() {
        datasource = UITableViewDiffableDataSource<Section, Item>(tableView: tableView) { tableView, indexPath, item in
            guard let cell = tableView.dequeueReusableCell(withIdentifier: "TempRowCell", for: indexPath) as? TempRowCell else { return nil }
...
extension TempStatisticsViewController: UITableViewDelegate {
